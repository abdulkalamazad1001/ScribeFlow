...
import { DeepgramLiveTranscriptionService } from "./services/deepgramLiveTranscriptionService.js";
...
export type ApiDependencies = {
  ...
  getLiveTranscriptionService: () => DeepgramLiveTranscriptionService;
...
export function createApiDependencies(): ApiDependencies {
  ...
  return {
    ...
    getLiveTranscriptionService: () => new DeepgramLiveTranscriptionService(),
